...
namespace ___template {
    ...
    void Init(Local<Object> exports) {
        ...
        // 设置函数体
        Local<ObjectTemplate> obj_with_fun_tpl = ObjectTemplate::New(isolate);
        obj_with_fun_tpl->Set(String::NewFromUtf8(isolate, "cat"), String::NewFromUtf8(isolate, "南瓜饼"));
        obj_with_fun_tpl->Set(String::NewFromUtf8(isolate, "dog"), String::NewFromUtf8(isolate, "蛋花汤"));
        obj_with_fun_tpl->SetCallAsFunctionHandler(Func);
        exports->Set(String::NewFromUtf8(isolate, "func"), obj_with_fun_tpl->NewInstance());
    }
